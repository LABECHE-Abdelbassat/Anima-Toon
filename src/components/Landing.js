...
const Landing = () => {
    ...
    useEffect(() => {
      dispatch(getNowPlayingMoviesList("https://api.themoviedb.org/3/movie/now_playing?api_key=52ef927bbeb21980cd91386a29403c78&language=en&with_genres=16,10751&include_video=true&include_adult=false&page=1"))
    }, [])
    

    function hundleClickfilm(id){
      axios.get('https://api.themoviedb.org/3/movie/'+id+"?api_key=52ef927bbeb21980cd91386a29403c78&language=en").then((res)=>{
  ...
  return (
    ...
    <Carousel className='carouselthe' fade>
      ...
      {nowPlayingFilm.map((item)=>{
        ...
        <img className='img-fluid' src={"https://image.tmdb.org/t/p/w1280/"+item.backdrop_path}></img>
